	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Danh sách phe duyệt</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a
								href='<c:url value="/home" />'>Home</a></li>
							<li class="breadcrumb-item active">Danh sách phe duyệt</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="content-body">
			...
			<form:form action="/FBMS/QuanLyVangNghi/danhsachduyet/search" method="GET">
								...
								<div class="table-responsive">
									<table id="datatable"
										...
										<thead>
											...
											<c:forEach var="danhsach" items="${listApprovedPage}">
												<tr>
