						...
						<div class="form-group col-sm-4">
							<label>Bộ phận</label> <select id="phongBan" name="phongBan">
								<c:forEach var="tempPhongBan" items="${listPhongBan}">
									<option value="${tempPhongBan.maPhongBan}"
										${tempPhongBan.maPhongBan == employeeProfile.idDepartment ? 'selected' : ''}>${tempPhongBan.tenPhongBan}</option>
								</c:forEach>
							</select>
						...
						<div class="form-group col-sm-4">
							<label>Quyền hạn</label> <select id="chucDanh" name="chucDanh">
								<c:forEach var="tempChucDanh" items="${listChucDanh}">
									<option value="${tempChucDanh.maChucDanh}"
										${tempChucDanh.maChucDanh == employeeProfile.idRights ? 'selected' : ''}>${tempChucDanh.tenChucDanh}</option>
								</c:forEach>
							</select>
